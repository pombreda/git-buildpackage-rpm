...
def build_parser(name):
    ...
    parser.add_conf_file_arg("--git-log", help="options to pass to git-log")
    ...
    version_group.add_arg("--qa", action="store_true",
                      help="Increment the Debian release number for a Debian "
                           "QA Team upload, and add a QA upload changelog "
                           "comment.")
    version_group.add_arg("--team", action="store_true",
                      help="Increment the Debian release number for a Debian "
                           "Team upload, and add a Team upload changelog "
                           "comment.")
    version_group.add_arg("--security", action="store_true",
                      help="Increment the Debian release number for a security "
                           "upload and add a security upload changelog "
                           "comment.")
    ...
    commit_group.add_conf_file_arg("--id-length", dest="idlen", type=int,
                      metavar="N",
